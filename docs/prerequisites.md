...
For all the beginners that are starting on the thesolution, this is for you to get started.
...
thesolution uses PHP v7.4. You can install it using one of the following ways:
...
5. In the new window, name your database as per your need, we are naming it “thesolution”. Now select Collation as utf8_general_ci. Now click on Create and your database will be created.

6. The newly created database will be empty now, as there are no tables in it.

7. Create a Folder in htdocs -
Now, locate the folder where you installed XAMPP and open the htdocs folder (usually c:/xampp). Create a new folder inside c:/xampp/htdocs/ and name it “thesolution” we will place web files in this folder. 
...
in thesolution so please make sure to check this out.
...
- [Introduction to Cypress](https://github.com/ColoredCow/thesolution/blob/master/docs/testing.md)
